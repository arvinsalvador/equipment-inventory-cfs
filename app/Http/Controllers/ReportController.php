...
class ReportController extends Controller
{
    ...
    private function payload(Request $request, string $report): array
    {
        ...
        return [
            ...
            'reportHeaderName' => $this->settings->get('report_defaults', 'report_header_name', 'CFS Equipment Inventory and Maintenance'),
            'reportFooterText' => $this->settings->get('report_defaults', 'report_footer_text', 'Generated by the equipment inventory and maintenance system.'),
            'includeGeneratedBy' => $this->settings->get('report_defaults', 'include_generated_by', true),
        ];
    }
