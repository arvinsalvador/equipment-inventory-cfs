            ...
            <table class="w-full text-left text-sm">
                <thead>
                    <tr class="border-b border-gray-200 text-gray-500 dark:border-gray-700 dark:text-gray-400">
                        ...
                        <th class="py-2 pe-4 font-medium">Open Count</th>
                        <th class="py-2 font-medium">Suggested Action</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($this->rows() as $row)
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="py-3 pe-4 text-gray-700 dark:text-gray-300">{{ $row->open_recommendation_count }}</td>
                            <td class="py-3 text-gray-700 dark:text-gray-300">{{ $row->suggested_action }}</td>
                        </tr>
                    @empty
                        <tr>
